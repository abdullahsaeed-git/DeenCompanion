 ...
 * PageActionsSheet
 *
 * Bottom sheet with actions for a selected page (jush/page mode).
 * Actions: Bookmark Page, Copy Page Info.
 * No "Mark as Last Read" — that's only for ayah mode.
 */
...
export function PageActionsSheet({
  ...
  const headerLine = pageInfo
    ? pageInfo.type === 'juz'
      ? `Juz ${pageInfo.juzNumber} · Page ${pageInfo.pageNumber}`
      : `Page ${pageInfo.pageNumber}`
    : '';

  const subLine = pageInfo?.surahName || '';
        ...
        >
          ...
          <View style={styles.sheetContent}>
            ...
            <View style={styles.header}>
              <Text style={styles.headerRef}>{headerLine}</Text>
              {subLine ? (
                <Text style={styles.headerSub}>{subLine}</Text>
              ) : null}
            </View>
            ...
            <View style={styles.actions}>
              ...
              >
                ...
                <View style={styles.actionMid}>
                  <Text style={styles.actionTitle}>Copy Page Info</Text>
                  <Text style={styles.actionSub}>Page number & surah</Text>
                </View>
                <Svg width="16" height="16" viewBox="0 0 20 20" fill="none">
                  <Path
                    d="M7.5 4.5 13 10l-5.5 5.5"
